...
{
    public class WxContactsBindlite
        : BindingList<WxContacts>
    {
        class BaseBindlite
        {
            public BaseBindlite(string dbName)
            {
                ...
                _connectName.CreateTable<WxContacts>();
            }
            ...
            public TableQuery<WxContacts> getTabble()
            {
                var obj = _connectName.Table<WxContacts>();
                return obj;
            }
        }
        ...
        public new void Add(WxContacts item)
        {
        ...
        private void Item_PropertyChanged(object sender, PropertyChangedEventArgs e)
        {
            ...
            try
            {
                WxContacts contact = sender as WxContacts;
                var value = contact.GetType().GetProperty(e.PropertyName).GetValue(contact);
        ...
        public bool Remove(WxContacts item)
        {
