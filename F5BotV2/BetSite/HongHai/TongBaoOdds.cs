...
namespace F5BotV2.BetSite.HongHai
{
        ...
        : OddsBingGouBase
    {
        ...
        public TongBaoOdds() {
            ...
            //五车
            this.GetOdds(CarNumEnum.P5, BetPlayEnum.单, true).SetValue("特码(第五球)", "5404");
            this.GetOdds(CarNumEnum.P5, BetPlayEnum.双, true).SetValue("特码(第五球)", "5405");
            this.GetOdds(CarNumEnum.P5, BetPlayEnum.大, true).SetValue("特码(第五球)", "5402");
            this.GetOdds(CarNumEnum.P5, BetPlayEnum.小, true).SetValue("特码(第五球)", "5403");
            this.GetOdds(CarNumEnum.P5, BetPlayEnum.尾大, true).SetValue("特码(第五球)", "5406");
            this.GetOdds(CarNumEnum.P5, BetPlayEnum.尾小, true).SetValue("特码(第五球)", "5407");
            this.GetOdds(CarNumEnum.P5, BetPlayEnum.合单, true).SetValue("特码(第五球)", "5408");
            this.GetOdds(CarNumEnum.P5, BetPlayEnum.合双, true).SetValue("特码(第五球)", "5409");
            this.GetOdds(CarNumEnum.P5, BetPlayEnum.福, true).SetValue("特码(第五球)", "21847", 2.5f);
            this.GetOdds(CarNumEnum.P5, BetPlayEnum.禄, true).SetValue("特码(第五球)", "21848", 2.5f);
            this.GetOdds(CarNumEnum.P5, BetPlayEnum.寿, true).SetValue("特码(第五球)", "21849", 2.5f);
            this.GetOdds(CarNumEnum.P5, BetPlayEnum.喜, true).SetValue("特码(第五球)", "21850", 2.5f);
            //总车
            this.GetOdds(CarNumEnum.P总, BetPlayEnum.单, true).SetValue("前五和值", "5366");
            this.GetOdds(CarNumEnum.P总, BetPlayEnum.双, true).SetValue("前五和值", "5367");
            this.GetOdds(CarNumEnum.P总, BetPlayEnum.大, true).SetValue("前五和值", "5364");
            this.GetOdds(CarNumEnum.P总, BetPlayEnum.小, true).SetValue("前五和值", "5365");
            this.GetOdds(CarNumEnum.P总, BetPlayEnum.尾大, true).SetValue("前五和值", "5368");
            this.GetOdds(CarNumEnum.P总, BetPlayEnum.尾小, true).SetValue("前五和值", "5369");
            this.GetOdds(CarNumEnum.P总, BetPlayEnum.龙, true).SetValue("", "5418");
            this.GetOdds(CarNumEnum.P总, BetPlayEnum.虎, true).SetValue("", "5419");
        }
    }
}
