...
namespace F5BotV2.BetSite.HongHai
{
        ...
        , INotifyPropertyChanged
    {
        ...
        //测试账号: wwww11
        //    密码: Aaa123
        public HongHaiMember(IBetBrowserBase browser)
        {
                                ...
                                while (true)
                                {
                                    ...
                                    try
                                    {
                                        if (p.UrlCurrent != null)
                                        {
                                            ...
                                            {
                                                hx.isLoginSuccess = true;
                                                if (Uuid > 0 && !string.IsNullOrEmpty(sid))
                                                {
                                                    break;
                                                }
                                                //获取赔率在这里
        ...
        public BetStatus Bet(BetStandardOrderList items)
        {
            ...
            //发送测试
            string url = $"{urlRoot}/comgame/setneworder";
