...
{
    public partial class CefBrowserView : Form
        , INotifyPropertyChanged
        , IBetBrowserBase
    {
        public CefCallBack<ResponseEventArgs> ResponseComplete;
        //浏览器对象
        ...
        private void initCrf()
        {
            ...
            chromeBroser = new ChromiumWebBrowserExtend("") {
                ...
                RequestHandler = new CefRequestHandler(ChromeBroser_ResponseComplete)
            };
            chromeBroser.FrameLoadEnd += ChromeBroser_FrameLoadEnd;
            chromeBroser.LifeSpanHandler = new OpenPageSelf();
            
            //chromeBroser.RequestHandler = new CefRequestHandler(ChromeBroser_ResponseComplete);
        ...
        //}
        private void ChromeBroser_ResponseComplete(object sender, ResponseEventArgs e)
        {
            //取cookie
            try
            {
            ...
            {
                Debug.WriteLine($"ChromeServices::ChromeBroser_ResponseComplete::Err={e.Url},Msg={ex.Message}");
            }

            //把事件发射出去
            ResponseComplete?.Invoke(sender, e);
        }
        ...
        //public IFrame Post(string url, byte[] postDataBytes, string contentType)
        //{
        //    IFrame frame = chromeBroser.GetMainFrame();
