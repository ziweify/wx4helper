...
namespace zhaocaimao.Services.AutoBet.Browser.PlatformScripts
{
    ...
    public class HongHaiScript : IPlatformScript
    {
        ...
        private void InitializeOddsMap()
        {
            ...
            // P2
            _oddsMap["P2大"] = new Models.OddsInfo(CarNumEnum.P2, BetPlayEnum.大, "平码二", 1.97f, "5378");
            _oddsMap["P2小"] = new Models.OddsInfo(CarNumEnum.P2, BetPlayEnum.小, "平码二", 1.97f, "5379");
            _oddsMap["P2单"] = new Models.OddsInfo(CarNumEnum.P2, BetPlayEnum.单, "平码二", 1.97f, "5380");
            _oddsMap["P2双"] = new Models.OddsInfo(CarNumEnum.P2, BetPlayEnum.双, "平码二", 1.97f, "5381");
            _oddsMap["P2尾大"] = new Models.OddsInfo(CarNumEnum.P2, BetPlayEnum.尾大, "平码二", 1.97f, "5382");
            _oddsMap["P2尾小"] = new Models.OddsInfo(CarNumEnum.P2, BetPlayEnum.尾小, "平码二", 1.97f, "5383");
            _oddsMap["P2合单"] = new Models.OddsInfo(CarNumEnum.P2, BetPlayEnum.合单, "平码二", 1.97f, "5384");
            _oddsMap["P2合双"] = new Models.OddsInfo(CarNumEnum.P2, BetPlayEnum.合双, "平码二", 1.97f, "5385");
            
            // P3
            _oddsMap["P3大"] = new Models.OddsInfo(CarNumEnum.P3, BetPlayEnum.大, "平码三", 1.97f, "5386");
            _oddsMap["P3小"] = new Models.OddsInfo(CarNumEnum.P3, BetPlayEnum.小, "平码三", 1.97f, "5387");
            _oddsMap["P3单"] = new Models.OddsInfo(CarNumEnum.P3, BetPlayEnum.单, "平码三", 1.97f, "5388");
            _oddsMap["P3双"] = new Models.OddsInfo(CarNumEnum.P3, BetPlayEnum.双, "平码三", 1.97f, "5389");
            _oddsMap["P3尾大"] = new Models.OddsInfo(CarNumEnum.P3, BetPlayEnum.尾大, "平码三", 1.97f, "5390");
            _oddsMap["P3尾小"] = new Models.OddsInfo(CarNumEnum.P3, BetPlayEnum.尾小, "平码三", 1.97f, "5391");
            _oddsMap["P3合单"] = new Models.OddsInfo(CarNumEnum.P3, BetPlayEnum.合单, "平码三", 1.97f, "5392");
            _oddsMap["P3合双"] = new Models.OddsInfo(CarNumEnum.P3, BetPlayEnum.合双, "平码三", 1.97f, "5393");
            
            // P4
            _oddsMap["P4大"] = new Models.OddsInfo(CarNumEnum.P4, BetPlayEnum.大, "平码四", 1.97f, "5394");
            _oddsMap["P4小"] = new Models.OddsInfo(CarNumEnum.P4, BetPlayEnum.小, "平码四", 1.97f, "5395");
            _oddsMap["P4单"] = new Models.OddsInfo(CarNumEnum.P4, BetPlayEnum.单, "平码四", 1.97f, "5396");
            _oddsMap["P4双"] = new Models.OddsInfo(CarNumEnum.P4, BetPlayEnum.双, "平码四", 1.97f, "5397");
            _oddsMap["P4尾大"] = new Models.OddsInfo(CarNumEnum.P4, BetPlayEnum.尾大, "平码四", 1.97f, "5398");
            _oddsMap["P4尾小"] = new Models.OddsInfo(CarNumEnum.P4, BetPlayEnum.尾小, "平码四", 1.97f, "5399");
            _oddsMap["P4合单"] = new Models.OddsInfo(CarNumEnum.P4, BetPlayEnum.合单, "平码四", 1.97f, "5400");
            _oddsMap["P4合双"] = new Models.OddsInfo(CarNumEnum.P4, BetPlayEnum.合双, "平码四", 1.97f, "5401");
            
            // P5
            _oddsMap["P5大"] = new Models.OddsInfo(CarNumEnum.P5, BetPlayEnum.大, "特码", 1.97f, "5402");
            _oddsMap["P5小"] = new Models.OddsInfo(CarNumEnum.P5, BetPlayEnum.小, "特码", 1.97f, "5403");
            _oddsMap["P5单"] = new Models.OddsInfo(CarNumEnum.P5, BetPlayEnum.单, "特码", 1.97f, "5404");
            _oddsMap["P5双"] = new Models.OddsInfo(CarNumEnum.P5, BetPlayEnum.双, "特码", 1.97f, "5405");
            _oddsMap["P5尾大"] = new Models.OddsInfo(CarNumEnum.P5, BetPlayEnum.尾大, "特码", 1.97f, "5406");
            _oddsMap["P5尾小"] = new Models.OddsInfo(CarNumEnum.P5, BetPlayEnum.尾小, "特码", 1.97f, "5407");
            _oddsMap["P5合单"] = new Models.OddsInfo(CarNumEnum.P5, BetPlayEnum.合单, "特码", 1.97f, "5408");
            _oddsMap["P5合双"] = new Models.OddsInfo(CarNumEnum.P5, BetPlayEnum.合双, "特码", 1.97f, "5409");
